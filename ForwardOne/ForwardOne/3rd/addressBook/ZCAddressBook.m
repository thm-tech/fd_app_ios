...
-(NSMutableDictionary*)getPersonInfo{
    ...
    for(int i = 0; i < CFArrayGetCount(results); i++)
    {
       ...
       if([telphone containsString:@"+"])
       {
           telphone = [telphone substringFromIndex:3];
       }
...
//        {
//            [dicInfoLocal setObject:telphone forKey:@"last"];
//        }
...
-(void)showViewMessageNameArray:(NSArray*)array Message:(NSString*)str{
    ...
    if ([MFMessageComposeViewController canSendText]) {
        ...
        //设置收件人, 需要一个数组, 可以群发短信
        self.messageViewController.recipients = array;
        
        //短信的内容
        self.messageViewController.body =str;
        
        //打开短信视图控制器
        [self.target presentViewController:self.messageViewController animated:NO completion:nil];
