...
@property (nonatomic,retain) UILabel *sendTitleLabel;
@property (nonatomic,retain) UIImageView *mmxTypeImageView;
@property (nonatomic,retain) UIImageView *mmxTypeImageView2;
