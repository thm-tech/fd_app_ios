...
-(void)createView{
    ...
    if (self.view.frame.size.height<500) {
        ...
        //二维码扫描的蓝色框背景图(扫描框)
        UIImage*image= [UIImage imageNamed:@"832@2x"];
          bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64,WIDTH, self.view.frame.size.height-64-HEIGHT*0.176)];
        //设置图片的显示方式，如居中，
    ...
    {
        //二维码扫描的蓝色框背景图(扫描框)
        UIImage*image= [UIImage imageNamed:@"1008@2x"];
        bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64,WIDTH, self.view.frame.size.height-64-HEIGHT*0.176)];
        //设置图片的显示方式，如居中，
        bgImageView.contentMode=UIViewContentModeTop;
        bgImageView.clipsToBounds=YES;
    ...
    else if (self.view.frame.size.height>600&self.view.frame.size.height<700)
    {
        ...
        //二维码扫描的蓝色框背景图(扫描框)
        UIImage*image= [UIImage imageNamed:@"1206@2x"];
        bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64,SCREENWIDTH, self.view.frame.size.height-64-HEIGHT*0.176)];
        //设置图片的显示方式，如居中，
        bgImageView.contentMode=UIViewContentModeTop;
        bgImageView.clipsToBounds=YES;
        bgImageView.image=image;
    ...
    {
        //二维码扫描的蓝色框背景图(扫描框)
        UIImage*image= [UIImage imageNamed:@"2016@3x"];
        bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64,WIDTH, self.view.frame.size.height-64-HEIGHT*0.176)];
        //设置图片的显示方式，如居中，
        bgImageView.contentMode=UIViewContentModeTop;
        bgImageView.clipsToBounds=YES;
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, (HEIGHT-64-HEIGHT*0.176)*0.8, WIDTH, HEIGHT*0.05)];
    label.text = @"扫朋友二维码名片加好友";
    label.textColor = [UIColor whiteColor];
    label.textAlignment = NSTextAlignmentCenter;
    label.lineBreakMode = NSLineBreakByWordWrapping;
    label.numberOfLines = 2;
    label.font=[UIFont systemFontOfSize:WIDTH * 0.0375];
    label.backgroundColor = [UIColor clearColor];
    [bgImageView addSubview:label];
    
    UILabel *label2 = [ZCControl createLabelWithFrame:CGRectMake(0, (HEIGHT-64-HEIGHT*0.176)*0.8+HEIGHT*0.05, SCREENWIDTH, HEIGHT*0.05) Font:WIDTH * 0.0375 Text:@"扫商店二维码成为粉丝"];
...
//    UILabel *label3 = [ZCControl createLabelWithFrame:CGRectMake(0, (HEIGHT-64-HEIGHT*0.176)*0.75+HEIGHT*0.05+HEIGHT*0.05, SCREENWIDTH, HEIGHT*0.05) Font:WIDTH * 0.0375 Text:@"扫商品条形码获取商品详情"];
...
//    [bgImageView addSubview:label3];
    ...
    //扫描框内的扫描的横线
     _line = [[UIImageView alloc] initWithFrame:CGRectMake(WIDTH*0.17, (HEIGHT-64-HEIGHT*0.176)*0.22,WIDTH*0.66, 2)];
    _line.image = [UIImage imageNamed:@"形状"];
    [bgImageView addSubview:_line];
   
    //
    
    //下方相册
    UIImageView*scanImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, bgImageView.frame.size.height+64, WIDTH, HEIGHT*0.176)];
    ...
    for (int i=0; i<unSelectImageNames.count; i++) {
        ...
        button.frame=CGRectMake(WIDTH/3*i+WIDTH/3/2, 0, WIDTH/3, HEIGHT*0.176);
    ...
    navImageView.image=[UIImage imageNamed:@"导航栏BG"];
    
    navImageView.userInteractionEnabled=YES;
    [self.view addSubview:navImageView];
    UILabel*titleLabel=[[UILabel alloc]initWithFrame:CGRectMake(0,18 ,WIDTH, 46)];
    ...
    [button setImage:[UIImage imageNamed:@"逛过_03"] forState:UIControlStateNormal];
    [button setFrame:CGRectMake(5,20, 48, 44)];
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:1 animations:^{
         ...
         _line.frame = CGRectMake(WIDTH*0.17,(HEIGHT-64-HEIGHT*0.176)*0.68,WIDTH*0.66, 2);
    }completion:^(BOOL finished) {
        [UIView animateWithDuration:1 animations:^{
          _line.frame = CGRectMake(WIDTH*0.17, (HEIGHT-64-HEIGHT*0.176)*0.22,WIDTH*0.66, 2);
        }];
...
- (void)pressPhotoLibraryButton:(UIButton *)button
{
    ...
    _line.frame = CGRectMake(WIDTH*0.15625, (HEIGHT-64-HEIGHT*0.176)*0.1687,WIDTH*0.6875, 2);
    num = 0;
    upOrdown = NO;
