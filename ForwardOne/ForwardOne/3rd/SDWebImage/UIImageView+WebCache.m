...
- (void)sd_setImageWithURL:(NSURL *)url {
    ...
    NSString *dataSettingString = [NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]objectForKey:DataSetting2]];
    NSLog(@"最最开始流量设置 = %@",dataSettingString);
    if([dataSettingString isEqualToString:@"1"])
    {
        [self sd_setImageWithURL:url placeholderImage:nil options:0 progress:nil completed:nil];
    }
    
   if([dataSettingString isEqualToString:@"2"])
   {
       [self sd_setImageWithURL:url placeholderImage:nil options:0 progress:nil completed:nil];

   }
    if([dataSettingString isEqualToString:@"(null)"])
    {
        [self sd_setImageWithURL:url placeholderImage:nil options:0 progress:nil completed:nil];
